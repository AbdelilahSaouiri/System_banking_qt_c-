...
void Password::on_password_push_clicked()
{
    if(!ui->password_pass->text().isEmpty()){
        ...
        QMessageBox::warning(this,"Password","svp entrer un mot de passe!!");
    }
}
