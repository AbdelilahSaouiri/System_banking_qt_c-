...
void enquiry::setdata(QString title)
{
...
{
    if(ui->enquiry_acc_no->text().isEmpty() && ui->enquiry_name->text().isEmpty()){
        QMessageBox::warning(this,"Enquiry Error","SVP Saisir le Nom ou Le Numero de Compte!!");
    }
    else if(ui->enquiry_acc_no->text().isEmpty() && !ui->enquiry_name->text().isEmpty()){
        ...
        if(enquiry::checkname(name)){
            ...
            ui->enquiry_account_detail->hide();
            QMessageBox::information(this,"Enquiry Error","Compte n'existe pas!!");
        }
    }
    else if(!ui->enquiry_acc_no->text().isEmpty() && ui->enquiry_name->text().isEmpty()){
        ...
        QMessageBox::warning(this,"Enquiry Information","SVP Saisir une seule Valeur!![No De Compte /Nom ]");
    }
}
...
void enquiry::on_enquiry_maintenance_clicked()
{
    ...
    if(query.next()){
        ...
        QMessageBox::warning(this,"Account","SVP selectionner Numero de Compte !!");
    }
    enquiry::disconn();
}
