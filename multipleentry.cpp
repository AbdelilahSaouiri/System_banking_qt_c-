...
bool multipleentry::checknull(){
    if(ui->multipleentry_acc_no_from->text().isEmpty() || ui->multipleentry_acc_no_to->text().isEmpty() || ui->multipleentry_name_from->text().isEmpty() || ui->multipleentry_name_to->text().isEmpty() || ui->multipleentry_amount->text().isEmpty() || ui->multipleentry_narration->text().isEmpty()){
        return true;
    }
    return false;
}
